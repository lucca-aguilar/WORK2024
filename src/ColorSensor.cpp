...
ColorSensor::ColorSensor(uint8_t S0, uint8_t S1, uint8_t S2, uint8_t S3, uint8_t output)
{
	pinMode(S0, OUTPUT);
	pinMode(S1, OUTPUT);
	pinMode(S2, OUTPUT);
...
int ColorSensor::colorRead(char color, int scaling)
{
...
String ColorSensor::closestColor(int distinctRGB[][3], String distinctColors[], int num_of_colors)
{
...
int ColorSensor::closestColor(int distinctRGB[][3], int distinctColors[], int num_of_colors)
{
...
int ColorSensor::closestColorIndex(int distinctRGB[][3], int num_of_colors)
{
